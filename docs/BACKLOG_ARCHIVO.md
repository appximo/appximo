# Appximo — backlog ARCHIVE (closed, done, review history)

Split out of docs/BACKLOG.md by CENTRO-MANDO-S2 (2026-09-17) so the register
holds only what is OPEN. Nothing here was edited — only moved. The panel does
not show this file unless asked.
...
## The old "Requires a decision from Miguel" table (now the DEC-* items; resolved rows kept here)
...
## Review history (moved from the BACKLOG header)
