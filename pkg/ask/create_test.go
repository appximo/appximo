...
func TestNote_HumanForms(t *testing.T) {
	...
	cases := []struct{ q, cuando, hasta, texto string }{
		...
		{"anota que se cayó la luz a las 3 y media por dos horas", "today 15:30", "today 17:30", "se cayó la luz"},
		...
		{"registra que la plataforma se cayó ayer de 7 a 2", "yesterday 07:00", "yesterday 14:00", "la plataforma se cayó"},
		{"anota que anoche se fue la luz a las 10", "yesterday 22:00", "", "se fue la luz"},
		...
		{"anota que el estudio estuvo caído entre las 7 y las 2 de la tarde", "today 07:00", "today 14:00", "el estudio estuvo caído"},
		...
		{"registra: la plataforma estuvo caída de 7 a 2", "today 07:00", "today 14:00", "la plataforma estuvo caída"},
		{"nota: hablé con el banco a las 3", "today 15:00", "", "hablé con el banco"},
		{"anota que se cayó la plataforma a las 7 y volvió a las 2", "today 07:00", "today 14:00", "se cayó la plataforma y volvió"},
		...
		{"anota que en la tarde se cayó la plataforma", "today", "", "se cayó la plataforma"},
		{"que hablé con el banco a las 3", "today 15:00", "", "hablé con el banco"},
		{"que se cayó la luz a las 3 y media por dos horas", "today 15:30", "today 17:30", "se cayó la luz"},
		...
		{"que ayer se fue el agua toda la tarde", "yesterday", "", "se fue el agua"},
		{"que hoy me llamó el contador", "today", "", "me llamó el contador"},
		{"que se dañó la moto el lunes", "last_monday", "", "se dañó la moto"},
