...
W4. A time field takes a token: "now", "today", "tomorrow", "day_after_tomorrow", "yesterday", "day_before_yesterday", "next_week", "next_monday"…"next_sunday", "last_monday"…"last_sunday" (the PAST occurrence — what a note about something that happened means by "el martes"), "end_of_month", optionally followed by " HH:MM" ("tomorrow 15:00"), or a YYYY-MM-DD the owner literally said. Never compute a date. "para mañana" → "tomorrow"; "el viernes" → "next_friday"; "hoy a las 3 de la tarde" → "today 15:00". A bare hour 1–6 is the afternoon ("a las 4" → 16:00), 7–12 the morning ("a las 10" → 10:00).
