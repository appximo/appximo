...
// (`appximo frontend-spec`): ONE binary serving a frontend + the generated
...
//     APPXIMO_AUTH_SIGNUP_ROLE=editor), the 401-bounce, expiry
...
// Run it:
//
//	DATABASE_URL=… JWT_SECRET=… ADMIN_KEY=… APPXIMO_AUTH_SIGNUP_ROLE=editor \
